...
public class TeacherBackInfoDaoImpl extends AbstractBaseDao<TeacherBackInfo> implements TeacherBackInfoDao {
	...
	@Override
	public List<BackInfoDetail> selectBackInfoDetailByEngclassIdAndUserId(Integer classid,Integer userid) {
	...
	@Override
	public List<BackInfoDetail> selectBackInfoDetailByEngclassIdAndTeacherId(Integer teacherId, Integer engclassId) {
	...
	@Override
	public Boolean insert(TeacherBackInfo teacherBackInfo) {
